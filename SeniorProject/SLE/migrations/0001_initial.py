# Generated by Django 2.0.1 on 2018-03-07 06:38
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            name='Lnlab',
            fields=[
                ('lnlabid', models.AutoField(primary_key=True, serialize=False)),
        ...
        migrations.CreateModel(
            name='Studyidentity',
            fields=[
                ('studynumber', models.CharField(max_length=6, primary_key=True, serialize=False)),
                ...
                ('maritalstatus', models.CharField(blank=True, max_length=10, null=True)),
        ...
        migrations.CreateModel(
            name='Visiting',
            fields=[
                ('visitingid', models.AutoField(primary_key=True, serialize=False)),
        ...
        migrations.CreateModel(
            name='Acrcriteria',
            fields=[
                ('studynumber', models.ForeignKey(db_column='studynumber', on_delete=django.db.models.deletion.DO_NOTHING, primary_key=True, serialize=False, to='SLE.Studyidentity')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('visitingid', models.ForeignKey(db_column='visitingid', on_delete=django.db.models.deletion.DO_NOTHING, primary_key=True, serialize=False, to='SLE.Visiting')),
                ('visitdate', models.DateField()),
                ...
                ('cp_6', models.CharField(blank=True, max_length=200, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cranialnervedetail', models.CharField(blank=True, max_length=50, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('studynumber', models.ForeignKey(db_column='studynumber', on_delete=django.db.models.deletion.DO_NOTHING, primary_key=True, serialize=False, to='SLE.Studyidentity')),
                ('familyhistoryofautoimmunedisease', models.CharField(blank=True, max_length=10, null=True)),
                ('systemicautoimmune', models.NullBooleanField()),
                ('sle', django.contrib.postgres.fields.ArrayField(base_field=models.TextField(blank=True), null=True, size=None)),
                ('ra', django.contrib.postgres.fields.ArrayField(base_field=models.TextField(blank=True), null=True, size=None)),
                ('dermatomyositis', django.contrib.postgres.fields.ArrayField(base_field=models.TextField(blank=True), null=True, size=None)),
                ('systemicsclerosis', django.contrib.postgres.fields.ArrayField(base_field=models.TextField(blank=True), null=True, size=None)),
                ('sjogrensyndrome', django.contrib.postgres.fields.ArrayField(base_field=models.TextField(blank=True), null=True, size=None)),
                ('tissuespecificautoimmune', models.NullBooleanField()),
                ('dmtypeone', django.contrib.postgres.fields.ArrayField(base_field=models.TextField(blank=True), null=True, size=None)),
                ('hashimotosthyroiditis', django.contrib.postgres.fields.ArrayField(base_field=models.TextField(blank=True), null=True, size=None)),
                ('multiplesclerosis', django.contrib.postgres.fields.ArrayField(base_field=models.TextField(blank=True), null=True, size=None)),
                ('myastheniagravis', django.contrib.postgres.fields.ArrayField(base_field=models.TextField(blank=True), null=True, size=None)),
                ('tissuespecificother', django.contrib.postgres.fields.ArrayField(base_field=models.TextField(blank=True), null=True, size=None)),
                ('renaldiseasefamilyhistory', models.CharField(blank=True, max_length=10, null=True)),
                ('nephroticsyndrome_glomerulardisease', django.contrib.postgres.fields.ArrayField(base_field=models.TextField(blank=True), null=True, size=None)),
                ('stone', django.contrib.postgres.fields.ArrayField(base_field=models.TextField(blank=True), null=True, size=None)),
                ('esrd', django.contrib.postgres.fields.ArrayField(base_field=models.TextField(blank=True), null=True, size=None)),
                ('renalother', django.contrib.postgres.fields.ArrayField(base_field=models.TextField(blank=True), null=True, size=None)),
            ],
            options={
        ...
        migrations.CreateModel(
            name='Laboratoryinventoryinvestigation',
            fields=[
                ('visitingid', models.ForeignKey(db_column='visitingid', on_delete=django.db.models.deletion.DO_NOTHING, primary_key=True, serialize=False, to='SLE.Visiting')),
                ('visitdate', models.DateField()),
                ...
                ('tdbilirubin', django.contrib.postgres.fields.ArrayField(base_field=models.FloatField(blank=True), null=True, size=None)),
                ...
                ('l1l4spinebmd_tscore', django.contrib.postgres.fields.ArrayField(base_field=models.FloatField(blank=True), null=True, size=None)),
                ('hipbmd_tscore', django.contrib.postgres.fields.ArrayField(base_field=models.FloatField(blank=True), null=True, size=None)),
                ('radiusbmd_tscore', django.contrib.postgres.fields.ArrayField(base_field=models.FloatField(blank=True), null=True, size=None)),
                ('stoolparasite', SLE.models.LabtypeField()),
                ('cxr', SLE.models.LabtypeField()),
                ('ekg', SLE.models.LabtypeField()),
                ('echo', SLE.models.LabtypeField()),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('visitingid', models.ForeignKey(db_column='visitingid', on_delete=django.db.models.deletion.DO_NOTHING, primary_key=True, serialize=False, to='SLE.Visiting')),
                ('visitdate', models.DateField()),
                ('msle_1_1', SLE.models.MedicationtypeField()),
                ('msle_1_2', SLE.models.MedicationtypeField()),
                ('msle_1_3', SLE.models.MedicationtypeField()),
                ('msle_2_1', SLE.models.MedicationtypeField()),
                ('msle_2_2', SLE.models.MedicationtypeField()),
                ('msle_3_1', SLE.models.MedicationtypeField()),
                ('msle_3_2', SLE.models.MedicationtypeField()),
                ('msle_3_3', SLE.models.MedicationtypeField()),
                ('msle_3_4', SLE.models.MedicationtypeField()),
                ('msle_4_1', SLE.models.MedicationtypeField()),
                ('msle_4_2', SLE.models.MedicationtypeField()),
                ('msle_4_3', SLE.models.MedicationtypeField()),
                ('msle_4_4', SLE.models.MedicationtypeField()),
                ('msle_4_5', SLE.models.MedicationtypeField()),
                ('msle_4_6', SLE.models.MedicationtypeField()),
                ('msle_4_7', SLE.models.MedicationtypeField()),
                ('msle_4_8', SLE.models.MedicationtypeField()),
                ('msle_4_9', SLE.models.MedicationtypeField()),
                ('msle_4_10', SLE.models.MedicationtypeField()),
                ('msle_4_11', SLE.models.MedicationtypeField()),
                ('mgt_1_1', SLE.models.MedicationtypeField()),
                ('mgt_1_2', SLE.models.MedicationtypeField()),
                ('mgt_1_3', SLE.models.MedicationtypeField()),
                ('mgt_1_4', SLE.models.MedicationtypeField()),
                ('mgt_1_5', SLE.models.MedicationtypeField()),
                ('mgt_2_1', SLE.models.MedicationtypeField()),
                ('mgt_2_2', SLE.models.MedicationtypeField()),
                ('mgt_2_3', SLE.models.MedicationtypeField()),
                ('mgt_2_4', SLE.models.MedicationtypeField()),
                ('mgt_3_1', SLE.models.MedicationtypeField()),
                ('mgt_3_2', SLE.models.MedicationtypeField()),
                ('mgt_3_3', SLE.models.MedicationtypeField()),
                ('mgt_4_1', SLE.models.MedicationtypeField()),
                ('mgt_4_2', SLE.models.MedicationtypeField()),
                ('mgt_4_3', SLE.models.MedicationtypeField()),
                ('mgt_4_4', SLE.models.MedicationtypeField()),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('modeofcontraceptives', models.TextField(blank=True, null=True)),
            ],
            options={
                'db_table': 'obgyn',
                'managed': False,
