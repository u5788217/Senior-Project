...
class Laboratoryinventoryinvestigation(models.Model):
    ...
    wbc_hpf1 = models.IntegerField(blank=True, null=True)
    rbc_hpf1 = models.IntegerField(blank=True, null=True)
    wbccasts1 = models.IntegerField(blank=True, null=True)
    rbccasts1 = models.IntegerField(blank=True, null=True)
    granularcasts1 = models.IntegerField(blank=True, null=True)
    wbc_hpf2 = models.IntegerField(blank=True, null=True)
    rbc_hpf2 = models.IntegerField(blank=True, null=True)
    wbccasts2 = models.IntegerField(blank=True, null=True)
    rbccasts2 = models.IntegerField(blank=True, null=True)
    granularcasts2 = models.IntegerField(blank=True, null=True)
    ...
    antism = models.TextField(blank=True, null=True)
    antirnp = models.TextField(blank=True, null=True)
    antiro = models.TextField(blank=True, null=True)
    antila = models.TextField(blank=True, null=True)
    aca = models.FloatField(blank=True, null=True)
    lupusanticoagulant = models.TextField(blank=True, null=True)
    ...
    hbsag = models.TextField(blank=True, null=True)
    antihbs = models.TextField(blank=True, null=True)
    antihbc = models.TextField(blank=True, null=True)
    antihcv = models.TextField(blank=True, null=True)
    antihiv = models.TextField(blank=True, null=True)
    anticic = models.TextField(blank=True, null=True)
    il6 = models.TextField(blank=True, null=True)
    ...
    cytokine = models.TextField(blank=True, null=True)
    l1l4spine_bmd = models.FloatField(blank=True, null=True)
    l1l4spine_tscore = models.FloatField(blank=True, null=True)
    l1l4spine_date = models.DateField(blank=True, null=True)
    hip_bmd = models.FloatField(blank=True, null=True)
    hip_tscore = models.FloatField(blank=True, null=True)
    hip_date = models.DateField(blank=True, null=True)
    radius_bmd = models.FloatField(blank=True, null=True)
    radius_tscore = models.FloatField(blank=True, null=True)
    radius_date = models.DateField(blank=True, null=True)
