...
class Laboratoryinventoryinvestigation(models.Model):
    ...
    wbc_hpf1 = models.FloatField(blank=True, null=True)
    rbc_hpf1 = models.FloatField(blank=True, null=True)
    wbccasts1 = models.FloatField(blank=True, null=True)
    rbccasts1 = models.FloatField(blank=True, null=True)
    granularcasts1 = models.FloatField(blank=True, null=True)
    wbc_hpf2 = models.FloatField(blank=True, null=True)
    rbc_hpf2 = models.FloatField(blank=True, null=True)
    wbccasts2 = models.FloatField(blank=True, null=True)
    rbccasts2 = models.FloatField(blank=True, null=True)
    granularcasts2 = models.FloatField(blank=True, null=True)
